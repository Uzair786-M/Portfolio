...
const Icon = <FontAwesomeIcon icon={faCheckCircle} color="#384c74"/>
...
const Contact = () => {
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#384c74" fill-opacity="0.9" d="M0,224L60,208C120,192,240,160,360,176C480,192,600,256,720,288C840,320,960,320,1080,304C1200,288,1320,256,1380,240L1440,224L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
  ...
  <div >
    <button type="submit" className="btn btn-lg mt-3" style={{backgroundColor:"#384c74",color:"#fff"}}>Request a Quote</button>
    </div>
